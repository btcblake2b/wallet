...
/// Crypto per il protocollo Nostr (NIP-01/NIP-04) usata dal client NWC/NCC.
///
/// // PERCHÉ: tutto puro Dart (bip340 + pointycastle, entrambi già vincolati
/// dal progetto) — nessuna dipendenza nativa, funziona su Android/iOS/web.
...
class NostrCrypto {
  ...
  /// Pubkey x-only (32 byte hex) dalla privkey — identità Nostr del client.
  ...
  /// punto condiviso, quindi il valore coincide con quello calcolato dal nodo.
